...
export class FirstMigration1703738467821 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "track_playcount" ("id" int NOT NULL IDENTITY(1,1), "playcount" int NOT NULL, "date" nvarchar(255) NOT NULL, "uriTrackUri" nvarchar(255), CONSTRAINT "PK_ed5ca30d5a281bd3b942dfbef24" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "track_playcount" ADD CONSTRAINT "FK_a06cdfd0c77d2a39e5181fd6ada" FOREIGN KEY ("uriTrackUri") REFERENCES "track"("track_uri") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "track_playcount" DROP CONSTRAINT "FK_a06cdfd0c77d2a39e5181fd6ada"`);
        ...
        await queryRunner.query(`DROP TABLE "track_playcount"`);
